...
public class MergeLeadsPage extends ProjectMethods{
	...
	public MergeLeadsPage enterUserName(String uName) {
	...
	public MergeLeadsPage enterPassword(String pwd) {
	...
	public MergeLeadsPage clickLoginForFailure() {
		click(eleLogin);
		return this;
	}
	...
	public MergeLeadsPage verifyErrorMsg(String expectedText) {
